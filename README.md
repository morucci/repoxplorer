...
Last release is RepoXplorer [1.0.0](https://github.com/morucci/repoxplorer/releases/tag/1.0.0).
...
```Shell
sudo yum install -y https://github.com/morucci/repoxplorer/releases/download/1.0.0/repoxplorer-1.0.0-1.el7.centos.noarch.rpm
