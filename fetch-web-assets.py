...
archives = {
    ...
    "simplePagination": "https://github.com/flaviusmatis/simplePagination.js/archive/07c37285fafc7dbabce0392f730037ac012cc3ea.tar.gz",
    "moment.js": "https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.17.1/moment.min.js",
    "d3.js": "https://cdnjs.cloudflare.com/ajax/libs/d3/3.1.6/d3.min.js",
    ...
    "dimple.js": "https://cdnjs.cloudflare.com/ajax/libs/dimple/2.2.0/dimple.latest.min.js",
...
def install_archive(name, path, basepath):
    if name == "moment.js":
        ...
        for f in glob.glob(os.path.join(os.path.dirname(path),
            ...
            shutil.move(f, os.path.join(basepath, 'images', os.path.basename(f)))
        ...
        for f in glob.glob(os.path.join(os.path.dirname(path),
            ...
            shutil.move(f, os.path.join(basepath, 'fonts', os.path.basename(f)))
        shutil.rmtree(os.path.join(os.path.dirname(path), "bootstrap-3.3.7-dist"))
        os.unlink(path)
    else:
        print "Install for %s not supported. skip." % name

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Fetch web assets for repoXplorer.')
