...
class TestErrorController(FunctionalTest):
    ...
    def setUp(self):
        ...
        self.db = set_projects_definition(con=self.con)
...
class TestHistoController(FunctionalTest):
    ...
    def setUp(self):
        ...
        c = Commits(self.con)
        c.add_commits(COMMITS)
        self.db = set_projects_definition(self.con)
          ...
          test:
            ...
            repos:
              monkey:
                template: default
        """
        self.db = set_projects_definition(self.con, new_projects_file)
            ...
            repos:
              monkey:
                ...
                tags:
                  - python
        """
        self.db = set_projects_definition(self.con, projects_file)
