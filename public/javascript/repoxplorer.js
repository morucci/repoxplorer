          ...
          $.each(obj.groups, function(j, group) {
            ...
            $("#fromdatepicker-" + i + '-' + j).datepicker(
                {dateFormat: "yy-mm-dd",
                 changeMonth: true,
                 changeYear: true});
            $("#fromdatepicker-" + i + '-' + j).datepicker('setDate', group['start-date']);
            $("#todatepicker-" + i + '-' + j).datepicker(
                {dateFormat: "yy-mm-dd",
                 changeMonth: true,
                 changeYear: true});
            $("#todatepicker-" + i + '-' + j).datepicker('setDate', group['end-date']);
          });
